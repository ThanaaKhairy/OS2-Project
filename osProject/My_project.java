...
//    public static void addRowToTable(int i_exested, int you_exested, int are_exested, int number_of_word, String subLongest, String subShorts){
//        System.out.println(
//    "Number of words = " + number_of_word +
//    ",'\ni' exists " + i_exested +
//    ", '\nyou' exists " + you_exested +
//    ", '\nare' exists " + are_exested+
//    ", \nLongest Word is " + subLongest +
//    ", \nShortest Word is " + subShorts 
//);
}
